...
func (c *positionsServiceClient) GetPositions(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Positions, error) {
	out := new(Positions)
	err := c.cc.Invoke(ctx, "/main.PositionsService/GetPositions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PositionsService_GetPositions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.PositionsService/GetPositions",
	}
...
func (c *sensorServiceClient) GetSensorStatusUpdates(ctx context.Context, in *Empty, opts ...grpc.CallOption) (SensorService_GetSensorStatusUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &SensorService_ServiceDesc.Streams[0], "/main.SensorService/GetSensorStatusUpdates", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightServiceClient) GetLightStatusUpdates(ctx context.Context, in *Empty, opts ...grpc.CallOption) (LightService_GetLightStatusUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &LightService_ServiceDesc.Streams[0], "/main.LightService/GetLightStatusUpdates", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *setLightsServiceClient) SetLights(ctx context.Context, in *LightsStatus, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/main.SetLightsService/SetLights", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SetLightsService_SetLights_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.SetLightsService/SetLights",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *setBrightnessServiceClient) SetBrightness(ctx context.Context, in *BrightnessStatus, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/main.SetBrightnessService/SetBrightness", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SetBrightnessService_SetBrightness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.SetBrightnessService/SetBrightness",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *setLightsStreamServiceClient) SetLightsStream(ctx context.Context, opts ...grpc.CallOption) (SetLightsStreamService_SetLightsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &SetLightsStreamService_ServiceDesc.Streams[0], "/main.SetLightsStreamService/SetLightsStream", opts...)
	if err != nil {
		return nil, err
	}
